    ...
    <Card
      ...
      summary={
        ...
        >
          ...
          <motion.li variants={childVariant} className="text-muted-foreground">
    ...
    >
      ...
      >
        ...
        <motion.li
          ...
          variants={childVariant}
        >
          Max temperature: <span>{Math.round(data?.daily[0].temp.max)}°C</span>
        </motion.li>
        <motion.li
          className="flex flex-row justify-between"
          variants={childVariant}
        >
          Min temperature: <span>{Math.round(data?.daily[0].temp.min)}°C</span>
        </motion.li>
        <motion.li
          className="flex flex-row justify-between"
          variants={childVariant}
